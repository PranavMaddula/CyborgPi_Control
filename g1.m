...
% Last Modified by GUIDE v2.5 08-Aug-2019 15:21:53
...
output = getlatestfile('C:\Users\Pranav Maddula\Documents\RamanLab\intan')
read_Intan_RHD2000_file(handles)

t_amplifier = getappdata(handles.pushbutton1,'t_amplifier');
amplifier_data = getappdata(handles.pushbutton1,'amplifier_data');
...
function read_Intan_RHD2000_file(handles,varargin)
...
setappdata(handles.pushbutton1,variable_name,variable); 
