...
def run(leftspeed, rightspeed):
    ...
    pwm_ENB.ChangeDutyCycle((rightspeed-2))
...
def back(leftspeed, rightspeed, wait):
    ...
    pwm_ENA.ChangeDutyCycle(leftspeed)
    pwm_ENB.ChangeDutyCycle((rightspeed-1))
    time.sleep(wait)
...
def ramprev(speed, rate):
    ...
    time.sleep(rate/2)
    pwm_ENA.ChangeDutyCycle(speed)
    pwm_ENB.ChangeDutyCycle((speed-1))
...
try:
    ...
    while True:
        ...
        f = open("/home/pi/CyborgPi/command.txt", "r")
        a = f.read()
        #print(a)
        if "1" in a:
            raise End
        ...
        if TrackSensorLeftValue2 == False and TrackSensorRightValue1 == False and TrackSensorLeftValue1 == False and TrackSensorRightValue2 == False:
            print("stop")
            if reverse == False :
                pause(5,5,waitTime)
                time.sleep(.3)
            else:
                pauserev(3,3,waitTime)
                time.sleep(.3)


        elif TrackSensorLeftValue2 == False and TrackSensorLeftValue1 == False:
            #print("go")
            if reverse == False:
                spin_left(20, 20)
            else:
        ...
        elif TrackSensorRightValue2 == False and TrackSensorRightValue1 == False:
            #print("go")
            if reverse == False:
                spin_right(20, 20)
            else:
        ...
        elif TrackSensorLeftValue2 == True and TrackSensorRightValue1 == True and TrackSensorLeftValue1 == True and TrackSensorRightValue2 == True:
            print("reverse")
            if reverse == False:
                reverse = True
                brake()
    ...
    pass
f.close()
f = open("/home/pi/CyborgPi/command.txt", "w")
f.write("0")
f.close()
pwm_ENA.stop()
pwm_ENB.stop()
